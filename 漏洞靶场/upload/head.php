	...
	<div id="head">
		...
		<div id="head_menu">
			...
			<?php if (isset($_SESSION["auth_user"])): ?>
				<span style="color:#fff;margin-left:12px"><?php echo htmlspecialchars($_SESSION["auth_user"]); ?><small style="color:#9cf;margin-left:4px">(<?php echo get_role_name(); ?>)</small></span>
